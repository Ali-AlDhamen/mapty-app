...
class App {
  ...
  _getPosition() {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        function () {
          alert('could not get your postiton');
        }
      );
    }
  }
  _loadMap(postiton) {
    const { latitude } = postiton.coords;
    const { longitude } = postiton.coords;
  ...
  _newworkout(e) {
    ...
    if (type === 'running') {
      ...
      if (
        ...
        return alert('inputs have to be postivie numbers');
    ...
    if (type === 'cycling') {
      ...
      if (
        ...
        return alert('inputs ahve to be postivie numbers');
  ...
  _rendermarkerworkout(workout) {
    L.marker(workout.coords)
      ...
      /**
       * Work out the number of spaces to indent the code.
       * @returns None
       */
      .setPopupContent(
